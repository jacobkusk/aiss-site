      ...
      >
        {Object.entries(OVERLAY_LABELS).map(([key, item]) => (
          <button
            ...
            style={{
              background: overlays[key] ? "rgba(255, 255, 255, 0.9)" : "transparent",
              border: "none",
              color: overlays[key] ? "#1c1c1e" : "rgba(255, 255, 255, 0.6)",
              fontSize: "12px",
              padding: "6px 12px",
              borderRadius: "5px",
              boxShadow: overlays[key] ? "0 1px 3px rgba(0,0,0,0.12)" : "none",
              cursor: "pointer",
              textAlign: "left",
              whiteSpace: "nowrap",
